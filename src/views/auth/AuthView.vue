<template>
    <div class="container" :class="{ right_panel_active: switchMode }" id="container">
        <div class="form">
            <div class="form-container sign-up-container">
                <form @submit.prevent="submitForm">
                    <h1>Create Account</h1>
                    <span>Fill these data fields</span>
                    <input type="name" placeholder="First Name" v-model.trim="firstName.val"
                        @blur="clearValidity('firstName')" :class="{ invalid: !firstName.isValid }" />
                    <p class="alert" v-if="!firstName.isValid">
                        Please enter your first name
                    </p>
                    <input type="name" placeholder="Last Name" v-model.trim="lastName.val" @blur="clearValidity('lastName')"
                        :class="{ invalid: !lastName.isValid }" />
                    <p class="alert" v-if="!lastName.isValid">
                        Please enter your last name
                    </p>
                    <input type="text" placeholder="Email" v-model.trim="email.val" @blur="clearValidity('email')"
                        :class="{ invalid: !email.isValid }" />
                    <p class="alert" v-if="!email.isValid">
                        Please enter valid email! (which also contains @ symbol )
                    </p>
                    <input type="password" placeholder="Password" v-model.trim="password.val"
                        @blur="clearValidity('password')" :class="{ invalid: !password.isValid }" />
...
.container {
    ...
    height: 83vh;  /* Covers the entire height */
